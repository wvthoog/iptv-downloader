...
from XstreamDL.XstreamDL_CLI.daemon import Daemon
from XstreamDL.XstreamDL_CLI.version import __version__
from XstreamDL.XstreamDL_CLI.headers.default import Headers
...
def main():
    ...
    parser.add_argument('--merge', action='store_true', default=None, help='merge the final audio and video file')
    parser.add_argument('--merge_files', action='store_true', help='audio and video file')
